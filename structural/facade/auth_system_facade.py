...
class AuthenticationSystem:
    ...
    def authenticate_user(self) -> bool:
        ...
        """
        hashed_password: str = self._generate_hashed_password()
        return bool(UserDBModel.get_user({'username': self.username, 'password': hashed_password}))
...
class AuthenticationSystemFacade:
    ...
    def __init__(self, username: str, password: str):
        self._auth_system_instance: AuthenticationSystem = AuthenticationSystem(username, password)
...
if __name__ == '__main__':
    auth_system_facade: AuthenticationSystemFacade = AuthenticationSystemFacade('alexey', 'password')
